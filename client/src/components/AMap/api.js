...
export const updateMap = (map, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    view: null,
...
export const updateMarker = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    map: (v) => entity.setMap(v),
    position: (v) => entity.setPosition(v),
    offset: (v) => entity.setOffset(v),
...
export const updateTraffic = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    map: (v) => entity.setMap(v),
    zIndex: (v) => entity.setzIndex(v),
...
export const updateMassMarks = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    zIndex: (v) => entity.setzIndex(v),
    opacity: null,
    zooms: null,
...
export const updatePolygon = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    map: (v) => entity.setMap(v),
    zIndex: (v) => entity.setzIndex(v),
...
export const updateCircle = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    map: (v) => entity.setMap(v),
    zIndex: (v) => entity.setzIndex(v),
...
export const updatePolyline = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    map: (v) => entity.setMap(v),
    zIndex: (v) => entity.setzIndex(v),
    bubble: null,
...
export const updateInfoWindow = (entity, newOptions, newEvents, oldOptions, oldEvents) => {
  let operators = {
    isCustom: null,
    autoMove: null,
